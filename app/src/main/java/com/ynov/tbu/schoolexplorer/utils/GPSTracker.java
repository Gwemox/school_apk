package com.ynov.tbu.schoolexplorer.utils;
...
public class GPSTracker implements LocationListener {
    ...
    private static GPSTracker INSTANCE = new GPSTracker();
    ...
    public GPSTracker() {
        this.mContext = SchoolExplorerApplication.getInstance().getBaseContext();
        getLocation();
    }
